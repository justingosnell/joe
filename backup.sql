...
\restrict Hm2nQJW3kBvah0W9Bodku5htnA7NCrVEnZNEIgxZHS2ZeLIUcufr3yC3CL31NQ0
...
--
-- Name: drizzle; Type: SCHEMA; Schema: -; Owner: joe
--

CREATE SCHEMA drizzle;


ALTER SCHEMA drizzle OWNER TO joe;

--
-- Name: public; Type: SCHEMA; Schema: -; Owner: joe
--

-- *not* creating schema, since initdb creates it


ALTER SCHEMA public OWNER TO joe;
...
--
-- Name: __drizzle_migrations; Type: TABLE; Schema: drizzle; Owner: joe
--
...
ALTER TABLE drizzle.__drizzle_migrations OWNER TO joe;

--
-- Name: __drizzle_migrations_id_seq; Type: SEQUENCE; Schema: drizzle; Owner: joe
--
...
ALTER SEQUENCE drizzle.__drizzle_migrations_id_seq OWNER TO joe;

--
-- Name: __drizzle_migrations_id_seq; Type: SEQUENCE OWNED BY; Schema: drizzle; Owner: joe
--
...
--
-- Name: categories; Type: TABLE; Schema: public; Owner: joe
--
...
ALTER TABLE public.categories OWNER TO joe;

--
-- Name: locations; Type: TABLE; Schema: public; Owner: joe
--
...
ALTER TABLE public.locations OWNER TO joe;

--
-- Name: media; Type: TABLE; Schema: public; Owner: joe
--
...
ALTER TABLE public.media OWNER TO joe;

--
-- Name: settings; Type: TABLE; Schema: public; Owner: joe
--
...
ALTER TABLE public.settings OWNER TO joe;

--
-- Name: users; Type: TABLE; Schema: public; Owner: joe
--
...
ALTER TABLE public.users OWNER TO joe;

--
-- Name: __drizzle_migrations id; Type: DEFAULT; Schema: drizzle; Owner: joe
--
...
--
-- Data for Name: __drizzle_migrations; Type: TABLE DATA; Schema: drizzle; Owner: joe
--
...
--
-- Data for Name: locations; Type: TABLE DATA; Schema: public; Owner: joe
--
...
--
-- Data for Name: media; Type: TABLE DATA; Schema: public; Owner: joe
--
...
--
-- Data for Name: settings; Type: TABLE DATA; Schema: public; Owner: joe
--
...
--
-- Name: __drizzle_migrations_id_seq; Type: SEQUENCE SET; Schema: drizzle; Owner: joe
--
...
--
-- Name: __drizzle_migrations __drizzle_migrations_pkey; Type: CONSTRAINT; Schema: drizzle; Owner: joe
--
...
--
-- Name: categories categories_pkey; Type: CONSTRAINT; Schema: public; Owner: joe
--
...
--
-- Name: locations locations_pkey; Type: CONSTRAINT; Schema: public; Owner: joe
--
...
--
-- Name: media media_pkey; Type: CONSTRAINT; Schema: public; Owner: joe
--
...
--
-- Name: settings settings_pkey; Type: CONSTRAINT; Schema: public; Owner: joe
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: joe
--
...
--
-- Name: categories_slug_unique; Type: INDEX; Schema: public; Owner: joe
--
...
--
-- Name: users_username_unique; Type: INDEX; Schema: public; Owner: joe
--
...
--
-- Name: media media_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: joe
--
...
--
-- Name: settings settings_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: joe
--
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON SEQUENCES TO joe;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON TYPES TO joe;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON FUNCTIONS TO joe;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON TABLES TO joe;
...
\unrestrict Hm2nQJW3kBvah0W9Bodku5htnA7NCrVEnZNEIgxZHS2ZeLIUcufr3yC3CL31NQ0
